...
exports.handler = async (event) => {
  ...
  const nomeIdioma = NOMES_IDIOMA[idioma] || null;
  const instrucaoIdioma = nomeIdioma && nomeIdioma !== NOMES_IDIOMA['pt-BR']
    ? '\n\nIMPORTANTE — IDIOMA DA RESPOSTA: a pessoa está usando o app em ' + nomeIdioma + '. Responda TODA a sua mensagem em ' + nomeIdioma + ', incluindo textos de anúncio, tabelas, cabeçalhos e qualquer conteúdo gerado — nunca em português, a menos que a pessoa troque de assunto e escreva em português diretamente. Nomes próprios de plataformas (Mercado Livre, Shopee, Hotmart etc.) e valores em R$ continuam como estão.'
    : '';
